package com.example.ksoap2webservicelibs;
...
public abstract class Ksoap2WebServiceBase extends AsyncTask<String, String, String> {
	...
	public Ksoap2WebServiceBase(Context c, String nameSpace, 
